...
public class Test {
    ...
    public static void setup() {
        ...
        panel1 = new JPanel();
        panel1.setBounds(0, -65, 1920 + 1, 1080 + 90);
        panel2 = new JPanel();
        panel2.setBounds(100, 100, 500, 500);
        panel3 = new JPanel();
        panel3.setSize(WINWIDTH + 1, WINHEIGHT + 85);
...
//            t5.start();
    ...
    private static class OpenMilitaryMenu implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            militaryMenu.show(panel2, 125, 55);
...
//        }
    ...
    public static void main(String[] args) {
        ...
        appFrame.setSize(WINWIDTH + 1, WINHEIGHT + 90);
